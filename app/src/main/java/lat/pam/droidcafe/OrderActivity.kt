...
class OrderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Gets a reference to the TextView in the layout
        val orderDataTextView = findViewById<TextView>(R.id.orderDataTextView)

        // Checks whether orderData is null or not
        if (orderData != "") {
            // If orderData is not null, display the value in the TextView
            orderDataTextView.text = "Anda Mengorder : $orderData"
        } else {
            // If orderData is null, display the message below
